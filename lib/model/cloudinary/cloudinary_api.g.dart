...
class _CloudinaryApi implements CloudinaryApi {
  _CloudinaryApi(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://api.cloudinary.com/v1_1/du5viar25/image/upload';
  }
