  ...
  final List<Map<String, String>> onboardingData = [
    {
      ...
      "title": "Find Team Members Near You",
      "desc":
          "Easily assign and collaborate with verified team members nearby — quick, efficient, and personalized task management.",
    },
    {
      "image": AppImages.onboarding2,
      "title": "Assign Tasks Seamlessly",
      "desc":
          "Connect with your team to assign and track tasks effortlessly — stay organized, on time, and productive.",
    },
    {
      "image": AppImages.onboarding3,
      "title": "Instant Messaging for Effective Teamwork",
      "desc":
          "Communicate instantly with your team to coordinate tasks, share updates, and ensure smooth project progress.",
    },
  ];
